      ...
      <div className="container-custom">
        {(c.heading || c.description) && (
          <div className="text-center mb-12">
            {c.heading && <h2 className="heading-lg mb-4">{c.heading}</h2>}
            {c.description && (
        ...
        <div className="max-w-4xl mx-auto">
          {(c.heading || c.description) && (
            <div className="text-center mb-10">
              {c.heading && <h2 className="heading-lg mb-4">{c.heading}</h2>}
              {c.description && <p className="text-lg text-gray-700">{c.description}</p>}
            </div>
          )}
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-primary-100 shadow-sm">
            ...
            {c.subdescription && (
              <p className="text-gray-700 text-center mb-6">{c.subdescription}</p>
            )}
            {c.listHeading && (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
              {(c.items ?? []).map((it, i) => {
                ...
                return (
                  ...
                  >
                    <div className="font-semibold text-gray-900 text-sm mb-1">{it.name}</div>
                    {it.description && (
          ...
          {c.trustBadge && (
            <p className="text-center mt-8 text-sm text-gray-600">{c.trustBadge}</p>
          )}
        </div>
      </div>
    </section>
